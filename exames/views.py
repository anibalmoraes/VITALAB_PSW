...
def solicitar_exames(request):
    ...
    if request.method == "GET":
        ...
        # CXalcular preço dos dados disponiveis
        preco_total = 0
...
def permitir_abrir_exame(request, exame_id):
    ...
    if not exame.requer_senha:
        ...
        # if exame.resultado.url == False:
        #     messages.add_message(request, constants.ERROR, "O exame não possui PDF")
        #     return redirect(f'/exames/gerenciar_exames/{exame.id}')
